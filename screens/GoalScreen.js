...
function GoalScreen() {
  ...
  function getThisMonthsPracticeMins() {
    if (practiceSessions != null) {
      ...
      var thisMonthsSession = practiceSessions.filter(
        (d) => checkIfDatesAreSameMonth(new Date(d.date), todaysDate) == true
      );
      var thisMonthsMins = 0;
      for (var p = 0; p < thisMonthsSession.length; p++) {
        if (
          thisMonthsSession[p].practiceTime != null &&
          Number(thisMonthsSession[p].practiceTime) != null
        ) {
  ...
  function getTodaysPracticeMins() {
    if (practiceSessions != null) {
      var todaysDate = new Date();
      var sessionsToday = practiceSessions.filter(
        (d) => checkifDateIsSame(new Date(d.date), todaysDate) == true
      );
      var todaysMins = 0;
      for (var j = 0; j < sessionsToday.length; j++) {
        if (
          sessionsToday[j].practiceTime != null &&
          Number(sessionsToday[j].practiceTime) != null
        ) {
  ...
  function calculateWeeklyProgressPercent() {
    if (weeklyGoalTemp == 0 || weeklyGoalTemp == null) {
      ...
      setWeeklyProgressPercent(
        Math.round((weeklyPracticeMins / (Number(weeklyGoalTemp) * 60)) * 10) /
          10
      );
    }
  }
  function calculateMonthlyProgressPercent() {
    if (monthlyGoalTemp == 0 || monthlyGoalTemp == null) {
      ...
      setMonthlyProgressPercent(
        Math.round(
          (monthlyPracticeMins / (Number(monthlyGoalTemp) * 60)) * 10
        ) / 10
      );
    }
  }
  function calculateDailyProgressPercent() {
    if (dailyGoalTemp == 0 || dailyGoalTemp == null) {
      ...
      setDailyProgressPercent(
        Math.round((todaysPracticeMins / Number(dailyGoalTemp)) * 10) / 10
      );
    }
  }
      ...
      <View style={style.titleContainer}>
        <TouchableOpacity
          style={[
            style.titleBlock,
            {
              backgroundColor: active == 0 ? theme.colors.SECONDARY : "white",
              borderWidth: 1,
        ...
        >
          <Text
            style={[
              ...
              {
                color:
                  active == 0 ? theme.colors.TEXT : theme.colors.TEXT_SECONDARY,
              },
            ]}
          >
            Daily
        ...
        <TouchableOpacity
          style={[
            style.titleBlock,
            {
              backgroundColor: active == 1 ? theme.colors.SECONDARY : "white",
              borderWidth: 1,
              borderColor: theme.colors.ACCENT,
            },
          ]}
        ...
        >
          <Text
            style={[
              ...
              {
                color:
                  active == 1 ? theme.colors.TEXT : theme.colors.TEXT_SECONDARY,
              },
            ]}
          >
            Weekly
        ...
        <TouchableOpacity
          style={[
            style.titleBlock,
            {
              backgroundColor: active == 2 ? theme.colors.SECONDARY : "white",
              borderWidth: 1,
              borderColor: theme.colors.ACCENT,
            },
        ...
        >
          <Text
            style={[
              ...
              {
                color:
                  active == 2 ? theme.colors.TEXT : theme.colors.TEXT_SECONDARY,
              },
            ]}
          >
            Monthly
      ...
      <ScrollView
        ...
        onScroll={(event) => {
          ...
          if (xA < Dimensions.get("window").width / 1.3) {
            ...
            xA >= Dimensions.get("window").width / 1.3 &&
            xA < (Dimensions.get("window").width * 2) / 1.3
          ) {
            setActive(1);
          ...
          >
            <View style={{ display: "flex", alignItems: "center", flex: 1 }}>
              <Animated.View style={{ flex: 0.2, opacity: fadeIn }}>
                <Text style={style.goalHeaderText}>
                  Daily Goal{" "}
                  {dailyGoalTemp ? dailyGoalTemp + " mins" : "not set"}
                </Text>
              </Animated.View>
              <View
                style={{
              ...
              >
                ...
                >
                  <Progress.Circle
                    ...
                    formatText={() => todaysPracticeMins + " mins"}
                    showsText={true}
              ...
              <View style={{ flex: 0.2, justifyContent: "flex-start" }}>
                <Modal
                  ...
                  transparent={true}
                  visible={dailyModal}
                  onRequestClose={() => setDailyModal(false)}
                >
                  <TouchableOpacity
                    activeOpacity={1}
                    onPressOut={() => {
        ...
        >
          <View style={{ display: "flex", alignItems: "center", flex: 1 }}>
            <View style={{ flex: 0.2 }}>
              <Text style={style.goalHeaderText}>
                Weekly Goal{" "}
                {weeklyGoalTemp ? weeklyGoalTemp + " hrs" : "not set"}{" "}
              </Text>
            </View>
            <View
              style={{
            ...
            >
              ...
              >
                <Progress.Circle
                  ...
                  formatText={() =>
                    Math.round((weeklyPracticeMins / 60) * 100) / 100 + " hrs"
                  }
                  showsText={true}
                  size={Dimensions.get("window").width / 2}
                  borderWidth={3}
        ...
        >
          ...
          >
            <View style={{ flex: 0.2 }}>
              <Text style={style.goalHeaderText}>
                Monthly Goal{" "}
                {monthlyGoalTemp ? monthlyGoalTemp + " hrs" : "not set"}
              </Text>
            </View>
            <View style={{ flexDirection: "row", flex: 0.4 }}>
              ...
              >
                <Progress.Circle
                  ...
                  formatText={() =>
                    Math.round((monthlyPracticeMins / 60) * 100) / 100 + " hrs"
                  }
                  showsText={true}
                  size={Dimensions.get("window").width / 2}
                  borderWidth={3}
            ...
            <View>
              <Modal
                ...
                onRequestClose={() => setMonthlyModal(false)}
              >
                <TouchableOpacity
                  activeOpacity={1}
                  onPressOut={() => {
                  ...
                  <View>
                    <View style={style.modalInnerContainer}>
                      ...
                      <TextInput
                        ...
                        value={
                          monthlyGoal ? monthlyGoal.toString() : monthlyGoal
                        }
                        maxLength={2}
                      />
                      <Button
